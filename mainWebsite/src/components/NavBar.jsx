...
export default function NavBar() {
  ...
  return (
    <>
      ...
      {/* Mobile Top Bar */}
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-gradient-to from-slate-900 to-slate-800 shadow-lg z-50 flex items-center justify-between px-4">
